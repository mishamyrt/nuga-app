...
export const versionStore = createStore(defaultVersion, { name: 'versionStore' })
export const updateUrlStore = createStore<Maybe<string>>(null, {
  name: 'updateUrlStore'
})

export const getVersionFx = createEffect('getVersionFx', { handler: getVersion })
export const checkUpdatesFx = createEffect('checkUpdatesFx', { handler: checkUpdates })
export const openBrowserFx = createEffect('openBrowserFx', { handler: openBrowser })
